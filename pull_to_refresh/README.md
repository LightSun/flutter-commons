...
* 1, support self PageManager, with repository and interceptor.
* 2, support self content widget, self item widget , self error widget, self empty widget, self load-more widget.
* 3, support add extra parameters for load
