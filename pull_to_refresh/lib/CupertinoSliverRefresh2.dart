...
///    scrollable space.
class CupertinoSliverRefreshControl2 extends StatefulWidget {
  ...
  /// a refresh.
  const CupertinoSliverRefreshControl2({
    Key key,
  ...
  static RefreshIndicatorMode state(BuildContext context) {
    final CupertinoSliverRefreshControlState state = context.findAncestorStateOfType<CupertinoSliverRefreshControlState>();
...
class CupertinoSliverRefreshControlState extends State<CupertinoSliverRefreshControl2> {
